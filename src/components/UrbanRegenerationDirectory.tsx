...
const UrbanRegenerationDirectory = () => {
    return (
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center relative">
          ...
          <div className="w-full md:w-2/5 space-y-6 md:pr-12 mb-8 md:mb-0">
            <div className="bg-white rounded-full w-16 h-16 flex items-center justify-center">
              ...
              <img 
                src="/icon/icon-urban-regen.svg" 
                alt="Democracy icon" 
                className="w-16 h-16"
              />
            </div>
            <h2 className="text-3xl md:text-4xl font-bold">
            Urban regeneration directory
            </h2>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  Your one-stop shop for Eco-technologies.
                   </p>
                </div>
  ...
  export default UrbanRegenerationDirectory;